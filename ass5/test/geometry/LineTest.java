...
//// Note because of peculiar TA's requirements, I can't implement Point.equals(Object).
// Therefore some tests are commented out
...
class LineTest {
    ...
    void contains() {
        Line l;
        l = new Line(new Point(1, 1), new Point(3, 3));
        Assertions.assertTrue(l.contains(new Point(2, 2)));
        Assertions.assertTrue(l.contains(new Point(1, 1)));
        Assertions.assertTrue(l.contains(new Point(3, 3)));
        Assertions.assertFalse(l.contains(new Point(0, 0)));
        Assertions.assertFalse(l.contains(new Point(4, 4)));
        Assertions.assertFalse(l.contains(new Point(3, 4)));
    }
