...
public class Line {
    ...
    public Line(Point start, Point end) {
        Objects.requireNonNull(start, "geometry.Point start cannot be null.");
        Objects.requireNonNull(end, "geometry.Point end cannot be null.");
    ...
    public String toString() {
        return String.format("geometry.Line{start=%s, end=%s}", this.start, this.end);
    }
    ...
    public List<Point> intersection(Line other) {
        Objects.requireNonNull(other, "geometry.Line other cannot be null.");
    ...
    public boolean contains(Point p) {
        return !this.intersection(new Line(p, p)).isEmpty();
    }
    ...
    public boolean isIntersecting(Line other1, Line other2) {
        Objects.requireNonNull(other1, "geometry.Line other1 cannot be null.");
        Objects.requireNonNull(other2, "geometry.Line other2 cannot be null.");
        return this.isIntersecting(other1) && this.isIntersecting(other2);
    }

    /**
     * Returns the closest intersection of the trajectory of this line with a rectangle.
     *
     * @param rect the rectangle
     * @return the closest intersection of the trajectory of this line with a rectangle
     */
