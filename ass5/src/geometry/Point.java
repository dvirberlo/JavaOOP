...
public class Point {
    ...
    public Point(Point other) {
        this(Objects.requireNonNull(other, "geometry.Point other cannot be null.").x, other.y);
    }
    ...
    public double distance(Point other) {
        Objects.requireNonNull(other, "geometry.Point other cannot be null.");
    ...
    public String toString() {
        return String.format("geometry.Point{x=%s, y=%s}", this.x, this.y);
    }
